...
/**
 * Placeholder for Anthropic Claude. Not implemented this sprint -- swap
 * for a real implementation behind AIProviderFactory when ready; no
 * caller of IAIProvider needs to change.
 */
export class ClaudeProvider implements IAIProvider {
  ...
  chat(_input: ChatCompletionInput): Promise<ChatCompletionResult> {
    return Promise.reject(new AIProviderNotImplementedError("ClaudeProvider"));
  }
}
